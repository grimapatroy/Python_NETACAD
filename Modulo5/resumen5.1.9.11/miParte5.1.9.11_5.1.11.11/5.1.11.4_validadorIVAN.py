# El cuarto programa implementa (en una forma ligeramente simplificada) un algoritmo utilizado
# por los bancos europeos para especificar los números de cuenta. El estándar llamado IBAN
...
# la reescritura del número, por ejemplo, de documentos en papel, como facturas o facturas en las
# computadoras.
...
#     pruebas rápidas y simples, pero no totalmente confiables, que muestran si un número es
#     inválido (distorsionado por un error tipográfico) o valido.
...
#     (este programa no lo hará, pero puedes modificar el código para cumplir con este
#     requisito si lo deseas; nota: pero debes enseñar al código a conocer todas las longitudes
...
#     dividiendolo entre 97. Si el residuo es 1, pasa la prueba de verificación de dígitos y el
#     IBAN puede ser válido.

# Observa el código en el editor. Analicémoslo:

#     Línea 03: pide al usuario que ingrese el IBAN (el número puede contener espacios, ya que mejoran
...
#     Línea 07: el IBAN no debe tener menos de 15 caracteres (esta es la variante más corta, utilizada
#     en Noruega).
#     Línea 08: si es más corto, se informa al usuario.
#     Línea 09: además, el IBAN no puede tener más de 31 caracteres (esta es la variante más larga,
#     utilizada en Malta).
...
# Agreguemos algunos datos de prueba (todos estos números son válidos; puedes invalidarlos cambiando
# cualquier carácter).
